    ...
    <div className="grid grid-cols-2 gap-20">
      ...
      <div className="w-2/3">
        ...
        <p className="text-xl leading-8 tracking-wider text-gray-300 ">
          Hey, I&#8216;m Bruno Genaro. I started developing websites back in
          2003, working in a music portal called ZineKaos.com.br (RIP), which
          you still can see its last version created in 2005. I&#8216;m
          ...
          Native, and Node.js). I&#8216;m originally from Brazil, and now I live
          in Orlando (Florida). When I&#8216;m not coding, you can see me at the
